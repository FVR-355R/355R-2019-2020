...
motor FeederLeftMotor = motor(PORT14, ratio18_1, false);
motor FeederRightMotor = motor(PORT4, ratio18_1, true);
motor RackAndPinionMotor = motor(PORT16, ratio18_1, false);
