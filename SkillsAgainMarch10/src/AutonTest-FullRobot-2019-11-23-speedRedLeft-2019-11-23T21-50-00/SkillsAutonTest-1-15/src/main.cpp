...
//    LiftStacker(0.35,true);
    ...
    FeederAction(50, false);    
    //FeederAction(0, false); 
    LiftStacker(1.0, false );
    MoveForward(-12.0, 30);

// Normal Auton is done -- now we do more
    ...
    MoveForward(35.0, 175);

// Slide over to wall and come back to know where we are

    Strafe(25.0,50);
    Strafe(-17.0,50);

// spin up feeder again
...
// Try for the blue goal

    RotateClockWise(57.0,100);
