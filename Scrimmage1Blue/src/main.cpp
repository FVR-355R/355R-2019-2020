...
void autonomous(void) {
 ...
 // This is what we want if on the blue side on the left.
 // Grabs the first block and pushes it into the small blue goal.
 // Originally written for the red side, to change flipped all the angles.
